...
import com.alibaba.csp.sentinel.dashboard.rule.file.FileGatewayDegradeProvider;
import com.alibaba.csp.sentinel.dashboard.rule.file.FileGatewayDegradePublisher;
 ...
 */
@Controller
@RequestMapping(value = "/gateway/degrade", produces = MediaType.APPLICATION_JSON_VALUE)
public class GatewayDegradeController {

    private final Logger logger = LoggerFactory.getLogger(GatewayDegradeController.class);
    ...
    @Autowired
    private FileGatewayDegradeProvider degradeProvider;

    @Autowired
    private FileGatewayDegradePublisher degradePublisher;
    ...
    public Result<List<DegradeRuleEntity>> queryMachineRules(HttpServletRequest request, String app, String ip, Integer port) {
        ...
        try {
            ...
            List<DegradeRuleEntity> rules = degradeProvider.getRules(app, ip, port);
    ...
    private void publishRules(String app, String ip, Integer port) throws Exception {
        ...
        degradePublisher.publish(app,ip,port,rules);
    }
}
