...
import com.alibaba.csp.sentinel.dashboard.rule.file.FileGatewaySystemProvider;
import com.alibaba.csp.sentinel.dashboard.rule.file.FileGatewaySystemPublisher;
 ...
 */
@RestController
@RequestMapping("/gateway/system")
public class GatewaySystemController {

    private final Logger logger = LoggerFactory.getLogger(GatewaySystemController.class);
    ...
    @Autowired
    private FileGatewaySystemProvider systemProvider;

    @Autowired
    private FileGatewaySystemPublisher systemPublisher;
    ...
    public Result<List<SystemRuleEntity>> apiQueryMachineRules(HttpServletRequest request, String app, String ip,
        ...
        try {
            ...
            List<SystemRuleEntity> rules = systemProvider.getRules(app,ip,port);
    ...
    public Result<SystemRuleEntity> apiAdd(HttpServletRequest request, String app, String ip, Integer port,
        ...
        try {
            ...
            e.printStackTrace();
            logger.info("Publish system rules fail after rule add",e);
        }
    ...
    public Result<SystemRuleEntity> apiUpdateIfNotNull(HttpServletRequest request,
        ...
        try {
            ...
            e.printStackTrace();
            logger.info("publish system rules fail after rule update",e);
        }
        return Result.ofSuccess(entity);
    }
    ...
    public Result<?> delete(HttpServletRequest request, Long id) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.info("publish system rules fail after rule delete",e);
        }
    ...
    private void publishRules(String app, String ip, Integer port) throws Exception {
        ...
        systemPublisher.publish(app,ip,port,rules);
    }
}
