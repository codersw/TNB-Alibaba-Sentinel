...
app.controller('GatewaySystemCtl', ['$scope', '$stateParams', 'GatewaySystemService', 'ngDialog', 'MachineService',
  function ($scope, $stateParams, GatewaySystemService,
    ...
    function getMachineRules() {
      ...
      GatewaySystemService.queryMachineRules($scope.app, mac[0], mac[1]).success(
        function (data) {
    ...
    function deleteRule(rule) {
      GatewaySystemService.deleteRule(rule).success(function (data) {
        if (data.code === 0) {
          getMachineRules();
          confirmDialog.close();
    ...
    function addNewRule(rule) {
      ...
      GatewaySystemService.newRule(rule).success(function (data) {
        if (data.code === 0) {
          getMachineRules();
    ...
    function saveRule(rule, edit) {
      GatewaySystemService.saveRule(rule).success(function (data) {
        if (data.code === 0) {
          getMachineRules();
          if (edit) {
            systemRuleDialog.close();
